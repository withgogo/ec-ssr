<template>
    ...
    <div style="padding: 35px;" class="bgfff">
        <div class="flex">
            ...
            <div style="width: 457px;" class="flex1">
                <Tips v-if="state.goodsChoiceType == 7"
                    :text="$t('packageGoods.packageText')" :position="false" bgColor="#f0ad4e" />
                <!-- 名称 -->
                <div>
                    <!-- slogan -->
                    ...
                    <div class="on-line" v-if="state.goodsData.goodsService"></div>
                </div>
                <!-- 活动 -->
                <div style="padding: 24px 0;" class="pointer"
                ...
                <div v-if="state.specList.length > 0" class="spec-scroll">
                    <div v-for="(item, index1) in state.specList" :key="index1">
                        ...
                        <div class=" flex  flex-wrap">
                            <span
                                class="package-item-content-spec  h5-package-item-content-spec pointer common-goods-spec-val "
                ...
                <!--库存  -->
                <div class="package-goods-stock pc-font16" style="padding-top: 10px;">
                    {{ $t('packageGoods.stock') }}:
                    {{ state.selectSpecPrice.count }}
                </div>
                <!-- 数量加加减 -->
                <div class="flex" style="padding: 24px 0;">
                ...
                <div>
                    ...
                    <div class="flex align-items-center">
                        ...
                        <div class="price h5-goods-price pc-font24"> {{ $t('moneyUnit') }}{{ state.selectSpecPrice.price
                            * state.count }}
                        </div>

                        <!-- default 价格 -->
                        <div class="default-text h5-goods-default-price on-line-text mright5 pc-font14"
                            v-if="state.selectSpecPrice.price !== state.selectSpecPrice.originPrice">
                            <!-- 原价 -->
                            {{ $t('groupAct.originalPrice') }}{{ $t('moneyUnit') }} {{ state.selectSpecPrice.originPrice
                            }}
                        </div>
                        <!-- 免运  -->
    ...
    <!-- 下部分 -->
    <div ref="guessCustomer" style="padding: 24px 0;" class="bgfff flex flex-center">
